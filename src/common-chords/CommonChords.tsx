...
function CommonChords({ musicKey, offset }: Keyed) {
  const { chords, f, f7, rom, note, Sep } = getRenderers(musicKey, offset);
    ...
    <section>
      ...
      <SeventhTeaser>
        ...
        {chords(
          f(
            "V/ii 7#9",
            "http://mrclay.org/piano/songs/C300C375uC3b6aC406yD40agC3ebcD30csD37cwD3bd0D3ed6C2ddqC31dsC37e6C3cekD3cjsC3alcD3aoyD31p6D37p8D2dpwC32q6C35qaC39qoD32120D3512aD3912i"
          ),
          f(
            "subV 7b5",
            "http://mrclay.org/piano/songs/C2b0C323C3b4C415D325hD415lD2b5nD3b5pC316kC376oC3b6qC416rD3bfxD37g0D31g1D41g9C30gyC37gzC3bh1C40h3D37tvD30twD3btwD40tw"
          )
        )}
        <Sep /> etc.
        <p>
